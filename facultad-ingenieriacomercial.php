...
<!-- caja seccion 1  -->
	...
	<div class="seccion-uno-comercial">
		<h1 class="gris-oscuro">Ingeniería Comercial</h1>
		<div class="introduccion-comercial">
			<h4 class="gris-oscuro">Introducción</h4>
			<p class="comercial-introduccion gris-oscuro">
		...
		<div class="informacion-directora-comercial">
			<img class="acredita-comercial" src="images/3acredita.png">
			<img src="http://lorempixel.com/310/190/">
			<h4 class="director-carrera-comercial gris-oscuro">Directora de Carrera </h4>
	...
	<div class="perfil-egresado-comercial">
...
<!-- cajaseccion 2 -->
 ...
 <div class="seccion-dos-comercial">
  	<div class="campo-comercial">
...
El Ingeniero Comercial de la Universidad Iberoamericana posee alta capacidad de emprendimiento y competencias
 para desempeñarse en marketing, finanzas, recursos humanos, economía y tecnologías de la información.
		...
		<a href="" class="morado descarga-malla-comercial">DESCARGA TU MALLA<a/>
  	</div>

  	<!-- info general comercial-->
  		<div class="info-general-comercial">
