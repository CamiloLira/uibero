...
<!-- caja seccion 1  -->
	...
	<div class="seccion-uno-salud">
		<h1 class="gris-oscuro">Enfermería</h1>
...
<!-- cajaseccion 2 -->
 ...
 <div class="seccion-dos-salud">
  	<div class="campo-salud">
  		...
  		<br>
  		<p class="gris-oscuro">La empleabilidad de los estudiantes es de un 99,1%, para el primer año posterior a la titulación, según datos del Mineduc. 
...
Los egresados de enfermería de la Universidad Iberoamericana, están preparados para trabajar en laboratorios, centros médicos, hospitales, CESFAM y centros de atención primaria de salud.
  	...
  	<!-- info general ingles-->
  		<div class="info-general-salud-enfermeria">
  				<h4 class="gris-oscuro">Información General</h4>
  					<br>
					<p class="gris-oscuro">Título Profesional </p>
					<p class="gris-oscuro">Enfermero (a)</p>
					<p class="gris-oscuro">Grado Academico</p>
					<p class="gris-oscuro">Licenciado(a) en Enfermería.</p>
