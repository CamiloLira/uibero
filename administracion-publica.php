...
<!-- caja seccion 1  -->
	...
	<div class="seccion-uno-fingenieria">
		<h1 class="gris-oscuro">Administración Pública</h1>
...
<!-- cajaseccion 2 -->
 ...
 <div class="seccion-dos-fingenieria">
  	...
  	<!-- info general comercial-->
  		<div class="info-general-fingenieria-admpublica">
  				<h4 class="gris-oscuro">Información General</h4>
  					<br>
					<p class="gris-oscuro">Título Profesional </p>
					<p class="gris-oscuro">Administrador Público. </p>
					<p class="gris-oscuro">Grado Académico</p>
					<p class="gris-oscuro">Licenciado en Gestión Pública.</p>
