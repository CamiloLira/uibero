			...
			<div class="facultad-ingeneria">
				...
				<p class="morado titulos-facultad">FACULTAD DE CIENCIAS 
					...
					<div class="mover-carreras-uno">
						...
						<a href="Ingeneria-Civil-Informatica.php" target="_blank"><p class="carreras-facultades ingenieria">Ingeneria Civil Informática</p><a/>
						...
						<div class="facultad-natural">
							...
							<p class="verde titulos-facultad">FACULTAD DE CIENCIAS 
								...
								<div class="mover-carreras-natural">
									...
									<a href="veterinaria.php" target="_blank"><p class="carreras-facultades natural">Medicina Veterinaria</p></a>
