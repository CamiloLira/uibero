...
<!-- cajaseccion 2 -->
 ...
 <div class="seccion-dos-fnaturales">
  	<div class="campo-fnaturales">
  		...
  		<br>
  		<p class="gris-oscuro">
Entre los campos laborales se encuentran:
Centros de investigación básica de
empresas privadas.
